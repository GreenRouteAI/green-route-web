      ...
      <Card
        ...
        <FormControl fullWidth>
          <Controller
            ...
            render={({ field }) => <TextField {...field} label={t('stores.fields.title')} required size='small' margin='none' variant='outlined' />}
          />
            ...
            render={({ field }) => {
              return (
                <ToggleButtonGroup
                  ...
                  <ToggleButton value={true}>{t('stores.fields.isActive.true')}</ToggleButton>
                  <ToggleButton value={false}>{t('stores.fields.isActive.false')}</ToggleButton>
                </ToggleButtonGroup>
              );
            }}
          />
        ...
        <FormControl fullWidth>
          <Controller
            ...
            render={({ field }) => <TextField {...field} label={t('stores.fields.email')} required size='small' margin='none' variant='outlined' />}
          />
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputMask {...field} mask='(999) 999 99 99' disabled={false}>
                ...
                {(props: TextFieldProps) => <TextField {...props} label={t('stores.fields.gsm')} size='small' margin='none' variant='outlined' />}
              </InputMask>
            )}
          />
