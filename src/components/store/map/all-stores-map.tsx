        ...
        {stores?.map(store => {
          ...
          return (
            <AdvancedMarker
              ...
              {(selectedStore?.id !== store.id || !selectedStore) && <img src='/images/marker-store.svg' alt={store.title} />}
              {selectedStore?.id === store.id && (
                <Card
                  ...
                  <Box
                    ...
                    <StoreStatus value={store.isActive} label={store.isActive ? t('stores.fields.isActive.true') : t('stores.fields.isActive.false')} />
                  </Box>
