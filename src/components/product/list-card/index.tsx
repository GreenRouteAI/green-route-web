...
export const ProductListCard = (props: Props) => {
  ...
  const categoryFilters = useMemo(() => {
    ...
    const filterValues = filter?.value?.map((value: string | number) => Number(value));
    ...
    <>
        ...
        {props.categories.map(category => {
          return (
            <Chip
              ...
              color={categoryFilters?.includes(category.id) ? 'primary' : undefined}
              sx={{
                color: categoryFilters?.includes(category.id) ? 'white' : undefined,
              }}
              onClick={() => {
      ...
      <Grid
        ...
        {products?.map(product => {
          const category = props.categories.find(c => c.id === product.category.id);
              ...
              <Card
                ...
                <CardActionArea
                  ...
                  <Box
                    ...
                    <CardMedia component='img' height='160' image={product.images[0]?.url} alt={product.name} />
                    <Button
