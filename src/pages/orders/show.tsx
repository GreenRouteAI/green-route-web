...
import { OrderDeliveryMap, OrderDetails, OrderProducts, Card } from '../../components';
...
export const OrderShow = () => {
  ...
  const canRejectOrder = record?.status.text === 'Pending' || record?.status.text === 'Ready' || record?.status.text === 'On The Way';
