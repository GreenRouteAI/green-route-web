...
import { useTranslate, HttpError, useApiUrl, useNavigation } from '@refinedev/core';
    ...
    <>
      ...
      <Grid container spacing='24px'>
        <Grid xs={12} md={12} lg={5}>
          <form>
            <Box mb='24px' display='flex' alignItems='center' justifyContent='center' gap='24px'>
              <Controller
                control={control}
                name='avatar'
                defaultValue={null}
                  ...
                  render={({ field }) => {
                    return (
                      <TextField
                        ...
                        sx={{
                          '& .MuiInputBase-input': {
                            backgroundColor: palette.mode === 'dark' ? '#1E1E1E' : palette.background.paper,
                          },
                        }}
