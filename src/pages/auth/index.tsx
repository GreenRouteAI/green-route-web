...
import { FinefoodsLogoIcon, FinefoodsLogoText } from '../../components/icons/finefoods-logo';
...
const renderAuthContent = (content: React.ReactNode) => {
  return (
    <div>
      <Link to='/'>
        <Box display='flex' alignItems='center' justifyContent='center' gap='12px' marginBottom='16px'>
          <FinefoodsLogoIcon
            style={{
              width: 64,
              height: 64,
